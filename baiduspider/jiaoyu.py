...
class JiaoyuNews(object):
	"""docstring for JiaoyuNews"""
	def __init__(self,url):
		super(JiaoyuNews, self).__init__()
		self.url = url
		self.codedetect = ''
		self.articlelink = []
	...
	def saveData(self,url,title,article):
		...
		filename ='./baidunews/jiaoyu/' + result + '.txt'
	...
	def getArticleFile(self):
		...
		print('get JiaoyuNewsFile success')

	def getJiaoyuNews(self):
		self.getArticleLink()
		self.getArticleFile()
