...
class TechNews(object):
	"""docstring for TechNews"""
	def __init__(self,url):
		super(TechNews, self).__init__()
		self.url = url
		self.codedetect = ''
		self.articlelink = []
	...
	def getArticleLink(self):
		...
		if self.codedetect != 'utf-8' and self.codedetect != 'gbk' and self.codedetect !='GB2312':
			...
			pattern = re.compile(r'<li><a target.*mon.*href.*</a></li>|<li><a mon.*target.*href.*</a></li>|<li><a href.*target.*mon.*</a></li>', re.M)
	...
	def getArticleFile(self):
		...
		print('get TechNewsFile success!!!')
