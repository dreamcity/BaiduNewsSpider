...
class YuleNews(object):
	"""docstring for YuleNews"""
	def __init__(self,url):
		super(YuleNews, self).__init__()
		self.url = url
		self.codedetect = ''
		self.articlelink = []
	...
	def saveData(self,url,title,article):
		...
		filename ='./baidunews/yule/' + result + '.txt'
	...
	def getArticleFile(self):
		...
		print('get YuleNews success!!!')

	def getYuleNews(self):
		self.getArticleLink()
		self.getArticleFile()
