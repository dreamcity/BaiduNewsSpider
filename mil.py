...
class MilNews(object):
	"""docstring for MilNews"""
	def __init__(self,url):
		super(MilNews, self).__init__()
		self.url = url
		self.codedetect = ''
		self.articlelink = []
	...
	def saveData(self,url,title,article):
		...
		# print('result: ', result )
		filename ='./baidunews/mil/' + result + '.txt'
	...
	def getBaiduMil(self):
		self.getArticleLink()
		self.getArticleFile()
url = 'http://mil.news.baidu.com/'
MilSpider = MilNews(url)
MilSpider.getBaiduMil()
